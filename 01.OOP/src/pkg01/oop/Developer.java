...
public class Developer {
	...
	public Developer() {
		...
		this.age = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Enter developer age: ", JOptionPane.QUESTION_MESSAGE));
		this.salary = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Enter developer salary: ", JOptionPane.QUESTION_MESSAGE));
	}
